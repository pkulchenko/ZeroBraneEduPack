...
local S = makeFractal(W,H,-szRe,szRe,-szIm,szIm,brdcl,brdup)
   ...
   --    S:SetArea(-1.406574048011,-1.406574042524,0.00025352709190672,0.00025353257887517)
      ...
      S:Register("FUNCT","julia2"    ,function (Z, C, R) Z:Set(cexp^(Z^3) - 0.621) end )
      S:Register("FUNCT","julia3"    ,function (Z, C, R) Z:Set(cexp^Z) Z:Sub(0.65) end )
      S:Register("FUNCT","julia4"    ,function (Z, C, R) Z:Pow(3) Z:Add(0.4)  end )
      S:Register("FUNCT","julia5"    ,function (Z, C, R) Z:Set((Z^4) * cexp^Z + 0.41 )  end )
      S:Register("FUNCT","julia6"    ,function (Z, C, R) Z:Set((Z^3) * cexp^Z + 0.33 )  end )
