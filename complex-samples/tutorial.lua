...
a:getNew():Print("3: ","\n")
a:getNew(complex.New(1,-1)):Print("3: ","\n")
...
complex.Convert(a):Print("Complex 1 : ","\n")
complex.Convert({a:getReal(),a.getImag()}):Print("Table 1 : ","\n")
complex.Convert({["r"] = a:getReal(), ["i"]=a.getImag()}):Print("Table 2 : ","\n")
complex.Convert({["asd"] = a:getReal(), ["fgh"]=a.getImag()},"asd","fgh"):Print("Table 3 : ","\n")
complex.Convert("7+j7"):Print("Direct string 1 : ","\n")
complex.Convert("7+7i"):Print("Direct string 2 : ","\n")
complex.Convert("7+J7"):Print("Direct string 3 : ","\n")
complex.Convert("7+7J"):Print("Direct string 4 : ","\n")
complex.Convert("7,7"):Print("Basic string 1 :  ","\n")
complex.Convert("7&7","&"):Print("Basic string 2 :  ","\n")
complex.Convert("{7,7}"):Print("Basic string 3 :  ","\n")
complex.Convert("/7,7/"):Print("Basic string 4 :  ","\n")
complex.Convert("[7,7]"):Print("Basic string 5 :  ","\n")
complex.Convert("(7,7)"):Print("Basic string 6 :  ","\n")
complex.Convert("|7,7|"):Print("Basic string 7 :  ","\n")
complex.Convert("<7,7>"):Print("Basic string 8 :  ","\n")
complex.Convert("/{7,7}/"):Print("Basic string 9 :  ","\n")
complex.Convert(7,7):Print("Number 1  : ","\n")
complex.Convert(true, true):Print("Boolean 1 : ","\n")
complex.Convert(true, false):Print("Boolean 2 : ","\n")
complex.Convert(false, true):Print("Boolean 3 : ","\n")
complex.Convert(false, false):Print("Boolean 4 : ","\n")
complex.Convert(nil, nil):Print("Boolean 5 : ","\n")
...
local ru = ( a:getNew() * 10 + complex.Convert(" 0.36+0.36j")):Print("Positive : ","\n")
local rd = (-a:getNew() * 10 + complex.Convert("-0.36-0.36j")):Print("Negative : ","\n")
