...
To *save* a program you can press @Ctrl-S@ or go to the @File | Save@ menu at the top of the window. If the program does not have a name yet, you will be prompted to provide a name for it. Pick a name that helps you (and others) recognize what the program does. As an example, the file that you are reading right now has the name @04-save-open@ because it is about saving and opening files.
